...
@Component({
  selector: 'app-associado-reader',
  templateUrl: './associado-reader.component.html',
  styleUrls: ['./associado-reader.component.css']
})
export class AssociadoReaderComponent implements AfterViewInit {
